  ...
  class OsBookingsController extends OsController {
    ...
    function change_status(){
      ...
      if($booking->save()){
        ...
        do_action('latepoint_booking_status_changed', $booking->id, $old_status);
    ...
    public function create(){
      ...
      if($customer->validate_custom_fields($custom_fields_data) && $customer->save()){
        ...
        if($booking->save()){
          ...
          $status = LATEPOINT_STATUS_SUCCESS;
          do_action('latepoint_booking_created', $booking->id);
    ...
    */
    ...
    public function update(){
      ...
      if($customer->validate_custom_fields($custom_fields_data) && $customer->save()){
        ...
        $form_values_to_update['booking[customer_id]'] = $booking->customer_id;
        if($booking->save()){
          do_action('latepoint_booking_updated', $booking->id);
    ...
    function daily_agent(){
      ...
      $work_periods_arr = OsBookingHelper::get_work_periods();
