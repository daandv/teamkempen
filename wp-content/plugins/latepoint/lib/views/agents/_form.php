	...
	<?php } ?>
		    <div class="white-box">
		      ...
		      <div class="white-box-content">
				    ...
				    <div class="os-row">
					    <div class="os-col-6"><?php echo OsFormHelper::text_field('agent[first_name]', __('First Name', 'latepoint'), $agent->first_name); ?></div>
					    <div class="os-col-6"><?php echo OsFormHelper::text_field('agent[last_name]', __('Last Name', 'latepoint'), $agent->last_name); ?></div>
				    </div>
				    <div class="os-row">
					    <div class="os-col-6"><?php echo OsFormHelper::text_field('agent[email]', __('Email Address', 'latepoint'), $agent->email); ?></div>
				    	<div class="os-col-6"><?php echo OsFormHelper::text_field('agent[phone]', __('Phone Number', 'latepoint'), $agent->phone); ?></div>
				    </div>
				    <?php if($show_admin_fields){ ?>
					    <div class="os-row">
						    <div class="os-col-6"><?php echo OsFormHelper::select_field('agent[wp_user_id]', __('Connect to WordPress User', 'latepoint'), $wp_users_for_select, $agent->wp_user_id, ['placeholder' => __('Select User', 'latepoint')]); ?></div>
					    	<div class="os-col-6"><?php echo OsFormHelper::select_field('agent[status]', __('Status', 'latepoint'), array(LATEPOINT_AGENT_STATUS_ACTIVE => __('Active', 'latepoint'), LATEPOINT_AGENT_STATUS_DISABLED => __('Disabled', 'latepoint')), $agent->status); ?></div>
					    </div>
					  <?php } ?>
					</div>
				</div>
            ...
            <?php echo OsFormHelper::textarea_field('agent[bio]', __('Bio Text', 'latepoint'), $agent->bio, array('rows' => 5)); ?>
						...
						<div class="latepoint-message latepoint-message-subtle"><?php _e('These value-label pairs will appear on agent information popup. You can enter things like years of experience, or number of clients served, to highlight agent accomplishments.'); ?></div>
		    ...
		    <div class="white-box">
		      ...
		      <div class="white-box-content">
				    ...
				    <div class="os-row">
					    <div class="os-col-6"><?php echo OsFormHelper::text_field('agent[extra_emails]', __('Additional Email Addresses', 'latepoint'), $agent->extra_emails); ?></div>
				    	<div class="os-col-6"><?php echo OsFormHelper::text_field('agent[extra_phones]', __('Additional Phone Numbers', 'latepoint'), $agent->extra_phones); ?></div>
				    </div>
		      </div>
		    </div>
		    <div class="white-box">
