  ...
  foreach ($bookings as $booking): ?>
    <tr>
      ...
      <td>
        ...
        <a href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('services', 'edit_form'), array('id' => $booking->service_id) ); ?>" target="_blank"><?php echo $booking->service->name; ?></a></td>
