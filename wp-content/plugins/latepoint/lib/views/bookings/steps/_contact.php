<div class="step-contact-w latepoint-step-content">
	<?php if(isset($booking) && $booking->customer_id){ ?>
		<div class="step-contact-logged-in-header-w">
	  	...
	  	<span><?php _e('Not You?', 'latepoint'); ?></span><a data-btn-action="<?php echo OsRouterHelper::build_route_name('bookings', 'logout_customer'); ?>" href="#" class="step-customer-logout-btn"><?php _e('Logout', 'latepoint'); ?></a>
	  </div>
