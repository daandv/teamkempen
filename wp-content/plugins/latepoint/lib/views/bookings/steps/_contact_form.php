<div class="os-row">
  <?php echo OsFormHelper::text_field('customer[first_name]', __('Your First Name', 'latepoint'), $booking->customer->first_name, array('class' => 'required'), array('class' => 'os-col-6')); ?>
  <?php echo OsFormHelper::text_field('customer[last_name]', __('Your Last Name', 'latepoint'), $booking->customer->last_name, array('class' => 'required'), array('class' => 'os-col-6')); ?>
  <?php echo OsFormHelper::text_field('customer[phone]', __('Your Phone Number', 'latepoint'), $booking->customer->formatted_phone, array('class' => 'os-mask-phone'), array('class' => 'os-col-6 os-col-sm-12')); ?>
  <?php echo OsFormHelper::text_field('customer[email]', __('Your Email Address', 'latepoint'), $booking->customer->email, array('class' => 'required'), array('class' => 'os-col-6 os-col-sm-12')); ?>
  <?php echo OsFormHelper::textarea_field('customer[notes]', __('Add Comments', 'latepoint'), '', array(), array('class' => 'os-col-12')); ?>
  <?php 
