...
class Rule_Is_Home extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'is_home';
		$this->label = __('Main Blog Page', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('is main blog page', i18n::$textdomain),
			'notin' => __('is not main blog page', i18n::$textdomain),
		);
	}
