...
class Rule_Rcp_Is_Active extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'rcp_is_active';
		$this->label = __('[RCP] Subscription Active', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('Has active subscription', i18n::$textdomain),
			'notin' => __('Doesn\'t have active subscription', i18n::$textdomain),
		);
	}
