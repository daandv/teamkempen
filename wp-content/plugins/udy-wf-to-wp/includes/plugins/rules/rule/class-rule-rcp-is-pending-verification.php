...
class Rule_Rcp_Is_Pending_Verification extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'rcp_is_pending_verification';
		$this->label = __('[RCP] Pending Email Verification', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('Is pending email verification', i18n::$textdomain),
			'notin' => __('Is not pending email verification', i18n::$textdomain),
		);
	}
