...
class Rule_Rcp_Is_Restricted_Content extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'rcp_is_restricted_content';
		$this->label = __('[RCP] Restricted Content', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('Is restricted content', i18n::$textdomain),
			'notin' => __('Is not restricted content', i18n::$textdomain),
		);
	}
