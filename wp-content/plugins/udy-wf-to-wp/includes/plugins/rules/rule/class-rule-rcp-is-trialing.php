...
class Rule_Rcp_Is_Trialing extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'rcp_is_trialing';
		$this->label = __('[RCP] Subscription Trialing', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('Is user trialing', i18n::$textdomain),
			'notin' => __('Is not user trialing', i18n::$textdomain),
		);
	}
