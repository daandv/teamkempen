...
class Rule_Woo_Is_Shop extends Rule {
	...
	public function __construct( $condition = '', $values = array() ) {
		...
		$this->key   = 'woo_is_shop';
		$this->label = __('[WOO] Shop Page', i18n::$textdomain);
	}
	...
	public function get_valid_conditions() {
		return array(
			'in'    => __('is shop page', i18n::$textdomain),
			'notin' => __('is not shop page', i18n::$textdomain),
		);
	}
