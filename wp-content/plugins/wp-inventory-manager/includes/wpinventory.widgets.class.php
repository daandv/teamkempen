...
class WPInventory_Categories_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$display_as_select = WPIMCore::dropdown_array( $this->get_field_name( 'display_as' ), $instance['display_as'], array(
			'list'   => WPIMCore::__( 'List' ),
			'select' => WPIMCore::__( 'Dropdown' )
		) );
		$sort_order_select = WPIMCore::dropdown_array( $this->get_field_name( 'sort_order' ), $instance['sort_order'], array(
