...
= Free Version =
This plugin is hosted on the repository for free and is **no different** than the licensed version of the plugin.  The only two differences for a licensed version of the plugin is support and ability to use paid add ons.  All paid add ons must have a licensed version of core.

= Licensing =
* You may purchase a license by going to the [WP Inventory License Page](https://www.wpinventory.com/wp-inventory-license/)
