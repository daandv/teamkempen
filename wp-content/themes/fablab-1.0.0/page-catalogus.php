<?php defined( 'ABSPATH' ) || exit; ?><!DOCTYPE html><!--  Last Published: Fri May 10 2019 11:12:00 GMT+0000 (UTC)  --><html data-wf-page="5cd52636f95bc7482779e1c2" data-wf-site="5cc2f2a63a80e8ed6d646eed"><head>
  <meta charset="utf-8">
...
<?php wp_enqueue_script("jquery"); wp_head(); ?><?php $udesly_fe_items = udesly_set_fe_items('catalogus'); ?></head>
<body class="<?php echo " ".join( ' ', get_body_class() ); ?>" udesly-page-name="catalogus"><?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  ...
  <div class="section-25">
    <div class="container-12 w-container">
      <div class="div-block-92">
        <h1 class="heading-26" data-udy-fe="text_-1643447751"><?php echo $udesly_fe_items['text_-1643447751']; ?></h1>
        <div class="text-block-41" data-udy-fe="text_-1755507807,text_185756197"><?php echo $udesly_fe_items['text_-1755507807']; ?><br><?php echo $udesly_fe_items['text_185756197']; ?></div>
      </div>
...
<?php wp_footer(); ?><?php udesly_set_fe_configuration($udesly_fe_items, 'catalogus'); ?><?php endwhile; endif; ?></body></html>