<?php defined( 'ABSPATH' ) || exit; ?><!DOCTYPE html><!--  Last Published: Fri May 10 2019 11:12:00 GMT+0000 (UTC)  --><html data-wf-page="5cc2f2a63a80e88238646ef7" data-wf-site="5cc2f2a63a80e8ed6d646eed"><head>
  <meta charset="utf-8">
...
<body class="body-7 <?php echo " ".join( ' ', get_body_class() ); ?>" udesly-page-name="search">
  ...
  <div class="section-16 category">
    <div class="container-6 w-container">
      <h1 class="heading-16" data-udy-fe="text_-507610754"><?php echo $udesly_fe_items['text_-507610754']; ?></h1>
    </div>
    <form action="<?php echo home_url( '/' ); ?>" class="search-form w-form" method="get"><input type="search" class="search-input w-input" maxlength="256" name="s" placeholder="e.g. sample" id="search" required><input type="submit" value="Search" class="search-button w-button"><input type="hidden" value="post" name="post_type" id="post_type"></form>
  </div>
  <div class="section-19">
    <div class="w-container">
      <form action="/search" class="search-2 w-form"><input type="search" class="w-input" autofocus="true" maxlength="256" name="query" placeholder="Search&#x2026;" id="search"><input type="submit" value="Search" class="w-button"></form>
    </div>
  </div>
    ...
    <div class="collection-list-wrapper w-dyn-list">
      <?php $prev_page_link = udesly_previous_posts_link(); $next_page_link = udesly_next_posts_link(); if( have_posts() ) :   ?><div class="collection-list w-dyn-items w-row">
        <?php while( have_posts() ) :  the_post(); ?><div class="collection-item-2 w-dyn-item w-col w-col-4">
          <a href="<?php the_permalink(); ?>" class="link-block-4 w-inline-block">
            <div class="div-block-42"><img src="<?php the_post_thumbnail_url('full'); ?>" alt="" class="image-26">
              <div class="div-block-43">
                ...
                <div class="div-block-40 w-clearfix">
                  <div class="div-block-87" style="background-image: url(<?php echo get_avatar_url( get_the_author_meta( 'ID' ) ); ?>);"></div>
  ...
  <script type="text/javascript">var $ = window.jQuery;</script><script src="<?php echo get_stylesheet_directory_uri(); ?>/js/webflow.js?v=1557486767" type="text/javascript"></script>
